...
* This document connects to the users database and runs multiple queries 


GITHUB URL:  <https://github.com/cmsc-vcu/cmsc508-fa2023-hw7-Nguson.git>
...
* The task for this assignment was to create tables in the sql file, connect it to the users database, and insert data into the tables. 
We are able to run queries after that is completed. 

## Crows-foot diagram

This is a crows foot diagram that represents the database!
...
The *people* table contains elements that describe a persons first name, last name, email, linkedin url, headshot url, discord handle, brief bio, and date joined.
...
The *skills* table contains elements that include skill name, skill description, skill tag, skill url, and skill time commitment.
...
The *roles* table contains elements that describe the role id, role name, and role sort priority.
...
* This homework has been very helpful! I learned how to write queries and create tables, insert into tables, delete tables, and im much more confidend in doing things in sql.
The lectures were extremely helpful for using different joins and getting specific sql queries to work.
